...
export const translations: Record<Language, Translations> = {
  uk: {
    ...
    dashboard: {
      ...
      subtitle:
        "Створюйте, досліджуйте та керуйте своїми містичними королівствами з потужними інструментами світобудування",
      createWorld: "Створити світ",
      ...
      gettingStartedDesc:
        "Почніть з створення свого першого світу або виберіть існуючий",
      worldMapHelp: "Карта світу",
      worldMapHelpDesc:
        "Візуалізуйте свій світ за допомогою нашого інтерактивного інструменту карт",
      ...
      createFirstWorldDesc:
        "Створіть свій перший фентезійний світ, щоб розпочати подорож світобудування. Додавайте локації, персонажів та істот, щоб оживити своє королівство.",
    ...
    messages: {
      ...
      noResultsDesc:
        "Спробуйте змінити пошукові терміни або налаштування фільтрів.",
      noLocationsYet: "Локацій ще немає",
      noLocationsDesc:
        "Почніть будувати свій світ, додавши локації, такі як міста, ліси, гори та інші визначні місця.",
      noCharactersYet: "Персонажів ще немає",
      noCharactersDesc:
        "Оживіть свій світ, створивши персонажів, таких як герої, лиходії, торговці та інші мешканці.",
      noCreaturesYet: "Істот ще немає",
      noCreaturesDesc:
        "Заселіть свій світ захоплюючими істотами, такими як дракони, єдинороги, гобліни та інші міфічні створіння.",
    ...
    settings: {
      title: "Налаштування",
      subtitle:
        "Налаштуйте свій досвід роботи з Конструктором фентезійних світів",
      ...
      resetDataDesc:
        "Це назавжди видалить всі ваші світи, персонажів та локації.",
  ...
  en: {
    ...
    dashboard: {
      ...
      createFirstWorldDesc:
        "Create your first fantasy world to begin your world-building journey. Add locations, characters, and creatures to bring your realm to life.",
    ...
    messages: {
      ...
      noLocationsDesc:
        "Start building your world by adding locations like cities, forests, mountains, and other landmarks.",
      noCharactersYet: "No Characters Yet",
      noCharactersDesc:
        "Bring your world to life by creating characters like heroes, villains, merchants, and other inhabitants.",
      noCreaturesYet: "No Creatures Yet",
      noCreaturesDesc:
        "Populate your world with fascinating creatures like dragons, unicorns, goblins, and other mythical beings.",
    ...
    settings: {
      ...
      resetConfirmationDesc:
        "This action would permanently delete all world data.",
      language: "Language",
  ...
  pl: {
    ...
    dashboard: {
      ...
      subtitle:
        "Buduj, eksploruj i zarządzaj swoimi mistycznymi królestwami dzięki potężnym narzędziom do tworzenia światów",
      createWorld: "Stwórz świat",
      ...
      gettingStartedDesc:
        "Zacznij od stworzenia swojego pierwszego świata lub wybierz istniejący",
      worldMapHelp: "Mapa świata",
      worldMapHelpDesc:
        "Wizualizuj swój świat za pomocą naszego interaktywnego narzędzia mapowego",
      ...
      createFirstWorldDesc:
        "Stwórz swój pierwszy świat fantasy, aby rozpocząć swoją podróż tworzenia światów. Dodawaj lokacje, postacie i stworzenia, aby ożywić swoje królestwo.",
    ...
    messages: {
      ...
      noResultsDesc:
        "Spróbuj dostosować terminy wyszukiwania lub ustawienia filtrów.",
      noLocationsYet: "Jeszcze brak lokacji",
      noLocationsDesc:
        "Zacznij budować swój świat, dodając lokacje takie jak miasta, lasy, góry i inne punkty orientacyjne.",
      noCharactersYet: "Jeszcze brak postaci",
      noCharactersDesc:
        "Ożyw swój świat, tworząc postacie takie jak bohaterowie, złoczyńcy, kupcy i inni mieszkańcy.",
      noCreaturesYet: "Jeszcze brak stworzeń",
      noCreaturesDesc:
        "Zaludnij swój świat fascynującymi stworzeniami takimi jak smoki, jednorożce, gobliny i inne mityczne istoty.",
    ...
    settings: {
      ...
      resetDataDesc:
        "To na stałe usunie wszystkie twoje światy, postacie i lokacje.",
